...
(function() {
    ...
    window.onload = function() {
        ...
        appendScript( sourceDir + 'markdown.js', function() {
            ...
            markdownsToHTML( document.getElementsByClassName('dice')         );
            markdownsToHTML( document.getElementsByClassName('note')         );
            markdownsToHTML( document.getElementsByClassName('counter-wrap') );
